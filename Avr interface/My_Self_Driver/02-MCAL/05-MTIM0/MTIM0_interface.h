...
#define MTIM0_OC0_HWPIN_DISCONNECTED			0
#define MTIM0_OC0_HWPIN_TOGGLE					1
#define MTIM0_OC0_HWPIN_CLEAR					2
#define MTIM0_OC0_HWPIN_SET						3

/*Compare Output Mode, Fast PWM Mode*/
#define MTIM0_OC0_HWPIN_NOVINVERTING_PWM		2
#define MTIM0_OC0_HWPIN_INVERTING_PWM			3
