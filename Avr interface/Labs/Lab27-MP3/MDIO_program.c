...
)
{
	...
	if ((ARG_u8pin>=0)&&(ARG_u8pin<=7))
	{
		...
		else if(ARG_u8Value==MDIO_TOGGLE)
		{
			switch(ARG_u8Port)
			{
				case MDIO_PORTA:TOGGLE_BIT(GPIOA->PORT, ARG_u8pin);L_stderrorError = E_OK;break;
				case MDIO_PORTB:TOGGLE_BIT(GPIOB->PORT, ARG_u8pin);L_stderrorError = E_OK;break;
				case MDIO_PORTC:TOGGLE_BIT(GPIOC->PORT, ARG_u8pin);L_stderrorError = E_OK;break;
				case MDIO_PORTD:TOGGLE_BIT(GPIOD->PORT, ARG_u8pin);L_stderrorError = E_OK;break;
				default:L_stderrorError = E_NOK;break;
			}
		}
